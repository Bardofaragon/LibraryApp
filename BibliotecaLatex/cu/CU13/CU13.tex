...
%-------------------------------------- COMIENZA descripción del caso de uso.
	...
	Las multas de los usuarios se registrarán para obligar al usuario a cumplir con la sanción.
		...
		\UCitem{Propósito}{El administrador registrará las multas de los usuarios para obligarlos a cumplir su sanción, mostrando el tipo de multa,la fecha en la que fue registrada,monto de la multa y las multas registradas con anterioridad. }
		\UCitem{Entradas}{
						\begin{itemize}
...
\IUfig[.7]{CU13/disenioA}{DS13}{Diagrama de Secuencia}