...
\begin{BussinesRule}{RN30}{Disponibilidad de un libro.} 
	\BRitem[Tipo:] Restricción (validación).
	%\BRitem[Autor:] Bautista Rosales Mauricio
...
Disponibilidad:
		...
		\end{itemize}
Estado Físico: Son las condiciones físicas del libro en las que se encuentra, estas pueden variar, las principales son :
	\begin{itemize} 
			\item Sucio
			\item Con Marcas 
			\item Arrugado
